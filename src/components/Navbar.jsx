...
export default function NavbarThree() {
  ...
  return (
    <div className="relative">
      ...
      {/* Main Navbar */}
      <nav className="bg-blue-400 border-b border-neutral-800 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                          ...
                          <div key={category}>
                            ...
                            <div className="space-y-3">
                              {courses.map((course) => (
                                ...
                                >
                                  <div className="text-white group-hover:text-orange-400 font-medium">
                                    {course.name}
                                  </div>
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2.5 bg-white border border-neutral-600 rounded-full text-white placeholder-neutral-500 outline-none focus:border-orange-500 transition-colors duration-200 w-72"
                />
              </div>
